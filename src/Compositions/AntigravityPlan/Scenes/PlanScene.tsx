...
const videoSrc = staticFile("antigravity_plan/antigravity_plan.mp4");
...
export const PlanScene: React.FC = () => {
  ...
  // Zoom Configuration: Edit these to change the focus point
  const zoomX = 0;
  const zoomY = 80;

  // Video Zoom logic: Strong 150% zoom starting at frame 83
  const videoScale = interpolate(frame, [83, 125], [1, 1.6], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  ...
  return (
    ...
    >
      {/* Background Depth - Cyan accent for Antigravity */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "radial-gradient(circle at 50% 50%, #00FBFF12 0%, transparent 70%)",
        }}
      />
      ...
      <div
        style={{
          ...
          boxShadow: "0 50px 100px rgba(0,0,0,0.8), 0 0 30px rgba(0, 251, 255, 0.15)",
          display: "flex",
      ...
      >
        ...
        {/* Video Content */}
        <div style={{ flex: 1, background: "#000", position: "relative", marginTop: 44 * s, overflow: "hidden" }}>
          <Video
            src={videoSrc}
            style={{
              width: "100%",
